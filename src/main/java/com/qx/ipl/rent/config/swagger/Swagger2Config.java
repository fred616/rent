package com.qx.ipl.rent.config.swagger;
...
public class Swagger2Config {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("国资处出租出借平台接口定义和规范").description("国资处出租出借平台接口定义和规范")
                .termsOfServiceUrl("http://****.com/").contact(new Contact("lf@****.com", "", "")).version("1.0")
                .license("版权所有 ©西安启夏信息科技有限公司").build();
    }
